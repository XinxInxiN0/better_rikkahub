...
val DEFAULT_PROVIDERS = listOf(
    ...
    ProviderSetting.OpenAI(
        ...
        description = {
            Text(
                text = buildAnnotatedString {
                    append("Provides OpenAI, Claude, Gemini and other mainstream models.")
                    appendLine()
                    append("Website: ")
        ...
        shortDescription = {
            Text(
                text = "Supports GPT, Claude, Gemini and 100+ models"
            )
        },
        models = listOf(
            Model(
    ...
    ProviderSetting.OpenAI(
        ...
        description = {
            MarkdownBlock(
                content = """
                    TokenPony provides a unified API gateway for multiple domestic models.
    ...
    ProviderSetting.OpenAI(
        ...
        description = {
            Text(
                text = buildAnnotatedString {
                    append("One-stop API relay platform. Website: ")
    ...
    ProviderSetting.OpenAI(
        ...
        description = {
            Text(
                text = buildAnnotatedString {
                    append("Enterprise AI service. Website: ")
    ...
    ProviderSetting.OpenAI(
        ...
        description = {
            Text(
                text = buildAnnotatedString {
                    append(
                        "Access mainstream AI models in one place with a lower entry cost.\n" +
                            "Website: "
                    )

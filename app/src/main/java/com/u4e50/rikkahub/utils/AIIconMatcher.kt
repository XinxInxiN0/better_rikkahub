...
private val PATTERN_ZHIPU = Regex("zhipu|鏅鸿氨|glm")
...
private val PATTERN_BYTEDANCE = Regex("bytedance|鐏北")
private val PATTERN_ALIYUN = Regex("aliyun|闃块噷浜憒鐧剧偧")
private val PATTERN_SILLICON_CLOUD = Regex("silicon|纭呭熀")
...
private val PATTERN_MOONSHOT = Regex("moonshot|鏈堜箣鏆楅潰")
private val PATTERN_302 = Regex("302")
private val PATTERN_STEP = Regex("step|闃惰穬")
private val PATTERN_INTERN = Regex("intern|涔︾敓")
...
private val PATTERN_PPIO = Regex("ppio|娲炬")
private val PATTERN_VERCEL = Regex("vercel")
private val PATTERN_GROQ = Regex("groq")
private val PATTERN_TOKENPONY = Regex("tokenpony|灏忛┈绠楀姏")
private val PATTERN_LING = Regex("ling|ring|鐧剧伒")
private val PATTERN_MIMO = Regex("mimo|xiaomi|灏忕背")
...
private val PATTERN_SEARCH_METASO = Regex("metaso|绉樺")
